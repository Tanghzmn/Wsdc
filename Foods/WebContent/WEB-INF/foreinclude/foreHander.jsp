                ...
                <div class="col-6 col-lg-2 col-md-6 col-sm-6 order-1 order-lg-1">
                    ...
                    <div class="logo">
                        <a href="${pageContext.request.contextPath}/fore/foreIndex">
                            <img src="${pageContext.request.contextPath}/assets/images/logo.png" class="img-fluid" style="border:10px #adf833 solid" alt="">
                        </a>
                    </div>
                                ...
                                <li class="active menu-item-has-children"><a href="#">美食分类</a>
                                    <ul class="sub-menu">
                                        <c:forEach items="${categories}" var="category">
                                            <li><a href="${pageContext.request.contextPath}/foreFindCategory?id=${category.id}" class="fruit">${category.name}</a></li>
                                        </c:forEach>
                                    </ul>
                                </li>
                                <li><a href="${pageContext.request.contextPath}/fore/forebought">我的订单</a></li>
                                <li><a href="${pageContext.request.contextPath}/fore/foreZixuns">园区资讯</a></li>
